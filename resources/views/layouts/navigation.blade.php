                ...
                @auth
                    @if(auth()->user()->role !== 'admin')
                        ...
                        <a href="{{ route('cart.index') }}" class="relative text-gray-700 hover:text-gray-900 ms-4" title="Корзина">
                            ...
                            @if($cartCount > 0)
                                <span class="absolute top-0 right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-red-600 rounded-full -translate-x-1/2 -translate-y-1/2">
                                    {{ $cartCount }}
                                </span>
                            @endif
                        </a>
                        ...
                        <a href="{{ route('favorites.index') }}" class="relative text-gray-700 hover:text-gray-900 ms-4" title="Избранное">
                            ...
                            @if($favoritesCount > 0)
                                <span class="absolute top-0 right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-yellow-500 rounded-full -translate-x-1/2 -translate-y-1/2">
                                    {{ $favoritesCount }}
                                </span>
                            @endif
                        </a>
