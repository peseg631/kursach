<nav x-data="{ open: false, searchOpen: false, searchQuery: '', searchResults: [] }" class="sticky top-0 z-50 flex items-center h-[80px] bg-[#365B6A] shadow-[0_3px_17px_0_rgba(0,0,0,0.25)]">
